...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>This Privacy Policy explains how AI Voyages LLC ("we", "us", "our") collects, uses, discloses, and protects your information when you use the Unofficial Walgreens Chatbot ("the Service"). By using the Service, you agree to the collection and use of information in accordance with this policy.</p>

    <h2>1. Information We Collect</h2>
    <p><strong>Personal Information:</strong> We may collect personal information that you provide to us when you:</p>
    <ul>
    ...
    <p><strong>Usage Data:</strong> We may also collect information on how the Service is accessed and used, such as IP addresses, browser details, pages visited, and time spent on those pages.</p>
    ...
    <h2>10. Contact Us</h2>
    <p>If you have any questions about this Privacy Policy, please contact us at: admin@aivoyages.net</p>
